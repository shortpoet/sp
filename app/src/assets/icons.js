export default {
  ...
  icons: [
    ...
    {
      icon: import("@/assets/azure_devicon_forest_green.svg"),
      name: "azure",
      displayName: "Azure",
    },
    {
    ...
    {
      icon: import("@/assets/terraform_devicon_forest_green.svg"),
      name: "terraform",
    ...
    {
      icon: import("@/assets/powershell_devicon_forest_green.svg"),
      name: "powershell",
      displayName: "Powershell",
    },
    {
      icon: import("@/assets/bash_devicon_forest_green.svg"),
      name: "bash",
      displayName: "Bash",
    },
    {
    ...
    {
      icon: import("@/assets/vue_devicon_forest_green.svg"),
      name: "vue",
      displayName: "VueJs",
    },
    {
      icon: import("@/assets/ts_devicon_forest_green.svg"),
      name: "ts",
    ...
    {
      icon: import("@/assets/d3_devicon_forest_green.svg"),
      name: "d3",
      displayName: "D3",
    },
    {
      icon: import("@/assets/tableau_logo.svg"),
      name: "tableau",
      displayName: "Tableau",
    },
    {
