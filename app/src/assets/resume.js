...
export const hardResume = {
  id: 0,
  title: 'Carlos Resume 2025 09 08',
  name: 'CARLOS',
  surname: 'SORIANO',
  address: 'Atlanta, GA',
  ...
  jobs: [
    {
      ...
      company: 'Lazlo 326',
      description:
        " • Developed an end-to-end data deployment pipeline & architecture integrating CosmosDB, Synapse, Databricks, and Power BI, streamlining analytics and reporting, and improving data processing speed. \\n\\r • Refactored and maintained core Terraform modules, aligning IaC with best practices, improving maintainability, and bolstering infrastructure deployments. \\n\\r • Standardized advanced Azure DevOps YAML scripting and engineered chained release builds, enhancing CI/CD management and deployment consistency. \\n\\r • Implemented robust PowerShell and .NET automation for build/release validations, credential and certificate management, and report deployments, reducing errors and improving accessibility. \\n\\r • Initiated a new product pipeline for partner integrations, simplifying shared infrastructure management and accelerating onboarding. \\n\\r • Designed a Terraform error-handling module with self-healing capabilities, reducing manual intervention and improving developer efficiency. \\n\\r • Configured RBAC in Terraform, managing roles, service principals, and securing permissions across environments to reinforce compliance. \\n\\r • Developed and delivered a .NET proof-of-concept for embedded Power BI reports, resolving a major pipeline automation roadblock. \\n\\r • Rapidly learned and implemented mobile CI/CD pipelines for MAUI applications targeting iOS App Store and Google Play, establishing the company's first automated mobile deployment process while meeting compliance requirements. \\n\\r • Implemented security best practices in CI/CD (code scanning, credential rotation, secrets management), reducing exposure risks. \\n\\r • Diagnosed and resolved cross-platform deployment failures, preventing service disruptions and improving system reliability. \\n\\r • Mentored colleagues in Terraform, PowerShell, and YAML debugging, improving team proficiency and accelerating delivery. \\n\\r • Recognized as a dependable resource for tackling high-priority issues and pioneering new solutions under tight deadlines.",
      startDate: '2024 (April)',
      endDate: '2025 (September)',
      dateCreated: '2024-04-10',
      comments: 'add Lazlo 326; more details; Lazlo exit'
    },
    {
      id: 21,
      experienceType: 'software',
